...
export const projects: Project[] = [
  {
    ...
    thumbnail: image("/images/projects/pipora/workspace.png"), heroImage: image("/images/projects/pipora/workspace.png"),
    gallery: [
      image("/images/projects/pipora/workspace.png"),
      image("/images/projects/pipora/marketing-transition.png"),
      image("/images/projects/pipora/marketing-dashboard.png"),
      image("/images/projects/pipora/sales-transition.png"),
      image("/images/projects/pipora/sales-dashboard.png"),
      image("/images/projects/pipora/sold-items.png"),
    ],
    featured: true,
  ...
  },
  {
    ...
    thumbnail: image("/images/projects/mobility.webp"), heroImage: image("/images/projects/mobility.webp"), gallery: [image("/images/projects/mobility.webp"), image("/images/projects/mobility-detail.webp")], featured: true,
  ...
  },
  {
    ...
    thumbnail: image("/images/projects/intelligence.webp"), heroImage: image("/images/projects/intelligence.webp"), gallery: [image("/images/projects/intelligence.webp"), image("/images/projects/intelligence-detail.webp")], featured: true,
  ...
  },
  {
    ...
    thumbnail: image("/images/projects/digital-mobility.webp"), heroImage: image("/images/projects/digital-mobility.webp"), gallery: [image("/images/projects/digital-mobility.webp"), image("/images/projects/digital-mobility-detail.webp")], featured: true,
  ...
  },
  {
    ...
    thumbnail: image("/images/projects/learning.webp"), heroImage: image("/images/projects/learning.webp"), gallery: [image("/images/projects/learning.webp"), image("/images/projects/learning-detail.webp")], featured: true,
