...
export function Hero() {
  ...
  return <section ref={root} className="hero" aria-labelledby="hero-title">
    ...
    <div className="hero-visual">
      <Image className="hero-portrait" src="/images/portraits/osama-cutout.webp" alt="Osama Kolachi" width={1240} height={1269} priority sizes="(max-width: 800px) 88vw, 48vw" />
    </div>
