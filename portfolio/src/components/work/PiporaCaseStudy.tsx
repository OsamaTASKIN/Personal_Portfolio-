...
const workspaces = [
  {
    ...
    image: withBasePath("/images/projects/pipora/marketing-transition.png"),
  },
  {
    ...
    image: withBasePath("/images/projects/pipora/sales-transition.png"),
  },
];
    ...
    <>
      ...
      <section className="case-visual-break">
        <div className="case-container">
          <div className="case-generated-visual">
            <Image src={withBasePath("/images/projects/pipora/unified-system.png")} alt="Abstract visualization of sales and marketing systems converging into one operational hub" fill sizes="(max-width: 800px) 94vw, 88vw" />
          </div>
      ...
      <section className="case-section pipora-feature pipora-feature-marketing">
        <div className="case-container">
          ...
          <BrowserFrame src={withBasePath("/images/projects/pipora/marketing-dashboard.png")} alt="Pipora marketing tools dashboard" />
      ...
      <section className="case-section pipora-feature pipora-feature-sales">
        <div className="case-container">
          ...
          <BrowserFrame src={withBasePath("/images/projects/pipora/sales-dashboard.png")} alt="Pipora sales dashboard with lead and revenue analytics" />
      ...
      <section className="case-section pipora-outcome">
        <div className="case-container">
          ...
          <div className="outcome-layout">
            <BrowserFrame src={withBasePath("/images/projects/pipora/sold-items.png")} alt="Pipora sold items view showing product and salesperson performance" />
